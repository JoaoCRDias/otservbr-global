local outfits = {
	...
	-- Config
			...
			mainMsg = "You will recieve both addons you choose.",
...
local addonDollItem = Action()

function addonDollItem.onUse(player, item, fromPosition, target, toPosition, isHotkey)
			player:sendAddonWindow(outfits)
			return true
	end

addonDollItem:id(8778)
addonDollItem:register()
