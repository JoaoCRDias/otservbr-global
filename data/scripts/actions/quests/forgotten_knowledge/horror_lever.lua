local config = {
	...
	bossPosition = Position(155, 608, 8),
	storageTimer = Storage.ForgottenKnowledge.HorrorTimer,
	playerPositions = {
		Position(188, 610, 8),
		Position(188, 611, 8),
		Position(188, 612, 8),
	...
	newPos = Position(155, 617, 8),
	bossRoomCenterPosition = Position(155, 613, 8),
	rangeX = 10,
	rangeY = 10,
	exitPos = Position(188, 616, 8),
	pushPos = Position(188, 610, 8)
}
