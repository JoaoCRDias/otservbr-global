local config = {
	leverAid = 14853,
	bossName = "Sir Baeloc",
	bossPosition = Position(378, 590, 8),
	storageTimer = Storage.Quest.GraveDanger.BaelocTimer,
	playerPositions = {
		Position(377, 565, 8),
		Position(378, 565, 8),
		Position(379, 565, 8),
	...
	newPos = Position(378, 583, 8),
	bossRoomCenterPosition = Position(378, 591, 8),
	rangeX = 10,
	rangeY = 11,
	exitPos = Position(378, 562, 8),
	pushPos = Position(377, 565, 8)
}
