local config = {
	...
	bossPosition = Position(378, 621, 8),
	storageTimer = Storage.Quest.GraveDanger.AzaramTimer,
	playerPositions = {
		Position(375, 645, 8),
		Position(376, 645, 8),
		Position(377, 645, 8),
	...
	newPos = Position(377, 633, 8),
	bossRoomCenterPosition = Position(377, 624, 8),
	rangeX = 10,
	rangeY = 10,
	exitPos = Position(376, 649, 8),
	pushPos = Position(375, 645, 8)
}
