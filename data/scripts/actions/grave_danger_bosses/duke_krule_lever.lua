local config = {
	leverAid = 14851,
	bossName = "Duke Krule",
	bossPosition = Position(409, 624, 8),
	bossRoomCenterPosition = Position(409, 624, 8),
	storageTimer = Storage.Quest.GraveDanger.KruleTimer,
	playerPositions = {
		Position(408, 645, 8),
		Position(409, 645, 8),
		Position(410, 645, 8),
	...
	pushPos = Position(408, 645, 8),
	newPos = Position(409, 633, 8),
	rangeX = 10,
	rangeY = 10,
	exitPos = Position(409, 647, 8),
