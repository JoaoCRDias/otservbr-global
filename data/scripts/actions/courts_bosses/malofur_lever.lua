local config = {
	...
	bossPosition = Position(391, 808, 8),
	storageTimer = Storage.Quest.TheDreamCourts.MalofurTimer,
	playerPositions = {
		Position(351, 797, 8),
		Position(351, 778, 8),
		Position(351, 779, 8),
	...
	newPos = Position(407, 809, 8),
	bossRoomCenterPosition = Position(398, 808, 8),
	rangeX = 18,
	rangeY = 11,
	exitPos = Position(351, 802, 8),
	pushPos = Position(351, 797, 8)
}
