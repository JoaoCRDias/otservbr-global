local config = {
	leverAid = 14832,
	bossName = "Maxxenius",
	bossPosition = Position(391, 836, 8),
	storageTimer = Storage.Quest.TheDreamCourts.MaxxeniusTimer,
	playerPositions = {
		Position(351, 819, 8),
		Position(351, 820, 8),
		Position(351, 821, 8),
	...
	newPos = Position(407, 838, 8),
	bossRoomCenterPosition = Position(398, 837, 8),
	rangeX = 18,
	rangeY = 11,
	exitPos = Position(351, 824, 8),
	pushPos = Position(351, 819, 8)
}
