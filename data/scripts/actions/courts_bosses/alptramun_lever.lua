local config = {
	leverAid = 14830,
	bossName = "Alptramun",
	bossPosition = {x = 389, y = 778, z = 8},
	storageTimer = Storage.Quest.TheDreamCourts.AlptramunTimer,
	playerPositions = {
		Position(351, 775, 8),
		Position(351, 776, 8),
		Position(351, 777, 8),
	...
	newPos = {x = 407, y = 779, z = 8},
	bossRoomCenterPosition = Position(398, 778, 8),
	rangeX = 18,
	rangeY = 11,
	exitPos = Position(351, 780, 8),
	pushPos = {x = 351, y = 775, z = 8}
}
