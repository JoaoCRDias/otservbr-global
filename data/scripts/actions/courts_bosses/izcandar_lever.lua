local config = {
	...
	bossPosition = Position(391, 894, 8),
	storageTimer = Storage.Quest.TheDreamCourts.IzcandarTimer,
	playerPositions = {
		Position(351, 865, 8),
		Position(351, 866, 8),
		Position(351, 867, 8),
	...
	newPos = Position(407, 896, 8),
	bossRoomCenterPosition = Position(398, 895, 8),
	rangeX = 18,
	rangeY = 11,
	exitPos = Position(351, 870, 8),
	pushPos = Position(351, 865, 8)
}
