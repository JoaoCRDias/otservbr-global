local config = {
	leverAid = 14833,
	bossName = "Plagueroot",
	bossPosition = Position(391, 865, 8),
	storageTimer = Storage.Quest.TheDreamCourts.PlaguerootTimer,
	playerPositions = {
		Position(351, 842, 8),
		Position(351, 843, 8),
		Position(351, 844, 8),
	...
	newPos = Position(407, 866, 8),
	bossRoomCenterPosition = Position(398, 865, 8),
	rangeX = 18,
	rangeY = 11,
	exitPos = Position(351, 847, 8),
	pushPos = Position(351, 842, 8)
}
